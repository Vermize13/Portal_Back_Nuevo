...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260204021837_FixIncidentHistoryFK")]
    partial class FixIncidentHistoryFK
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "audit_action", new[] { "create", "update", "delete", "login", "logout", "assign", "transition", "backup", "restore", "upload", "download", "http_request", "sql_command", "export", "comment", "unknown" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "bug_type", new[] { "functional", "visual", "performance", "security", "other" });
            ...
            modelBuilder.Entity("Domain.Entity.SystemConfiguration", b =>
                {
            ...
            modelBuilder.Entity("Domain.Entity.UserInvitation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entity.UserInvitation", b =>
                {
                    b.HasOne("Domain.Entity.User", "InvitedByUser")
                        .WithMany()
